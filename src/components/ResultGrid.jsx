  ...
  if (!tracks || tracks.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center h-[50vh] text-center animate-in fade-in">
        ...
        <button onClick={onReset} className="px-6 py-2 bg-white text-black font-bold rounded-full hover:scale-105 transition-transform">
          Try Again
        </button>
      </div>
    );
  ...
  return (
    <div className="flex flex-col items-center animate-in fade-in duration-1000 max-w-xl mx-auto w-full">
      ...
      <div className="w-full flex items-center justify-between mb-6">
        ...
        <button onClick={onReset} className="flex items-center gap-2 text-sm text-neutral-500 hover:text-white transition-colors">
